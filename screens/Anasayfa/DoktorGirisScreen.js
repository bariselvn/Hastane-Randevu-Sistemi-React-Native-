...
import {UpdateDoktorId} from '../../redux/actions'
 class DoktorGirisScreen extends React.Component {
    constructor(props) {
        super(props);
      ...
      updateId=(doktorId)=>{
        UpdateDoktorId(doktorId);
      }
      loginFunc(){
        fetch("https://randevusistemi.azurewebsites.net/api/Doktor/GirisYap/"+this.state.tckn+"/"+this.state.sifre+"/").then(res=>{
        ...
        if(res.ok){
           ...
           .then(data=>{
             ...
             this.props.navigation.navigate('DoktorIndex');
           })
...
export default connect(mapStateToProps)(DoktorGirisScreen);